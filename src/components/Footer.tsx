                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li><Link href="#hero" className="text-slate-400 hover:text-blue-400 transition-colors">Beranda</Link></li>
                            <li><Link href="#about" className="text-slate-400 hover:text-blue-400 transition-colors">Tentang Kami</Link></li>
                            <li><Link href="#services" className="text-slate-400 hover:text-blue-400 transition-colors">Layanan</Link></li>
                            <li><Link href="#gallery" className="text-slate-400 hover:text-blue-400 transition-colors">Galeri</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3 text-slate-400">
                                <MapPin className="shrink-0 mt-1 text-blue-500" size={18} />
